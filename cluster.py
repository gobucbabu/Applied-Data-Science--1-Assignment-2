...
df_arableland = df_arableland_0.loc[:, ["Country Name", "2015"]].copy()
df_cerealyield = df_cerealyield_0.loc[:, ["Country Name", "2015"]].copy()
...
df_cluster = df_cluster_0.rename(columns={"2015_x": "Arable Land",
                                          "2015_y": "Cereal Yield"})
...
plt.scatter(df_cluster_norm["Arable Land"], df_cluster_norm["Cereal Yield"], 10, labels,
            marker="o", cmap='Set1')
